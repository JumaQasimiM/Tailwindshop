const Home = () => {
  return (
    <main>
      <div className="flex-col gap-1 md:flex md:flex-row ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 bg-slate-400 flex-3 p-3 my-2 ">
          ...
          <div className="bg-slate-300 p-3 h-70 rounded shadow-md shadow-sky-200">
            ...
            <button className="w-1/2 bg-green-900 text-white px-3 py-1 my-2 rounded-full text-sm cursor-pointer hover:bg-green-900 hover:text-slate-300 hover:scale-102 transition-all duration-300">Add to Cart</button>
          </div>
          <div className="bg-slate-300 p-3 h-70 rounded shadow-md shadow-sky-200">
            <img
              className="w-full h-[60%] object-contain rounded cursor-pointer"
